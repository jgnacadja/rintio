  ...
  <div>
    ...
    <footer class="bg-primary">
      <div class="text-white md:flex w-full px-4 md:px-0 md:mx-0 md:text-left">
        ...
        <!-- Col-2 -->
        <div
          class="hidden md:block -my-5 p-8 w-full sm:w-4/12 md:w-3/12 md:m-5"
        >
          <!-- Col Title -->
        ...
        <div class="w-full md:hidden max-w-md py-2 mx-auto px-4">
          ...
          <div
            ...
            :class="openProducts ? 'scale-100 opacity-100 delay-100 duration-100' : 'scale-95 opacity-0 duration-75'"
          >
            <!-- Links -->
            <a
              href="https://coraq.formation.chmp.org"
        ...
        <div class="w-full md:hidden max-w-md py-2 mx-auto px-4">
          ...
          <div
            class="pt-2 pb-2 transition transform ease-out"
            :class="openLinks ? 'scale-100 opacity-100 delay-100 duration-100' : 'scale-95 opacity-0 duration-75'"
          >
            <!-- Links -->
            <a
              href="#"
        ...
        <div class="-my-5 py-8 px-4 md:px-8 w-full sm:w-4/12 md:w-3/12 md:m-5">
          <div class="h-auto">
            ...
            <div class="flex mt-4" v-res>
              ...
              />
              <button
                class="bg-orange text-white rounded-r-sm h-auto text-xs p-3 bg-secondary px-3 py-2 font-semibold focus:outline-none"
              >
