              ...
              <div class="columns is-multiline is-12">
                <div class="column is-half">
                  <figure>
                    ...
                    <figcaption class="">
                      <b
                        v-html="$static.articles.belongsTo.edges[0].node.title"
                      >
                      </b>
                      <p
                        v-html="
                ...
                <div class="column is-half">
                  <figure>
                    ...
                    <figcaption class="">
                      <b
                        v-html="$static.articles.belongsTo.edges[1].node.title"
                      ></b>
                      <p
                        v-html="
                ...
                <div class="column is-half mb-0">
                  <figure>
                    ...
                    <figcaption>
                      <b
                        v-html="$static.articles.belongsTo.edges[2].node.title"
                      ></b>
                      <p
                        v-html="
                ...
                <div class="column is-half mb-0">
                  <figure>
                    ...
                    <figcaption class="">
                      <b
                        v-html="$static.articles.belongsTo.edges[3].node.title"
                      ></b>
                      <p
                        v-html="
        ...
        <div class="">
          <figure>
            ...
            <div class="card zoom">
                  ...
                  <span class="tag  is-primary is-large" style="height: 25px;position: relative;bottom: 40px;left: 35%;">
                    <b style="font-size:15px;">S'inscrire</b></span>   
            </div>
             <div class="row"><b v-html="$static.feature.belongsTo.edges[1].node.title"></b>
                     <div class="columns is-mobile">
                        <figcaption class="column is-11">
                      
                      <p
                        v-html="$static.feature.belongsTo.edges[1].node.metaDescription"
                        class="space"
                      ></p>
                      </figcaption>
                     <div class="column" style="margin-top:75px;font-size:16.5px;margin-left:-25px;"><arrowicon /></div>

                      </div>
                    </div>
          </figure>
        </div>
        <!-- CE AUI EST AU MILIEUX -->
        <!-- <div v-for="article in $static.articles.belongsTo.edges" :key="article.node.id">
          <figure class="zoom">
            <button class="has-text-primary is-small" id="" style="position: relative; top:110px; right: -150px">
              Nos Engagements
            </button>
            <g-image :src="article.node.coverImage" class="" style="padding-top: 40px" />
            <span class="tag is-link" id="bouton2mob">S'inscrire</span>
            <figcaption>
              <b v-html="article.node.title"></b>
              <p v-html="article.node.metaDescription"></p>
              <arrowicon />
            </figcaption>
          </figure>
        </div> -->
              ...
              <div class="columns is-multiline is-12">
                <div class="column is-half">
                  <figure>
                    ...
                    <div class="row"><b
                     ...
                     <div class="column" style="margin-top:80px;font-size:16.5px;margin-left:-15px;"><arrowicon /></div>
                ...
                <div class="column is-half">
                  <figure>
                    ...
                    <div class="row"><b
                     ...
                     <div class="column" style="margin-top:20px;font-size:16.5px;margin-left:-15px;"><arrowicon /></div>
                ...
                <div class="column is-half mb-0">
                  <figure>
                    ...
                    <div class="row">
                      <div class="columns is-mobile">
                        <figcaption class="column is-10">
                          
                          <p v-html=" $static.articles.belongsTo.edges[3].node.metaDescription
                              " class="space" >
                          </p>
                                            
                        </figcaption>
                        <div class="column" style="margin-top:18px;font-size:16.5px;"><arrowicon /></div>      
                  ...
                  <figure>
                    <div class="zoom">
                      <span
                        ...
                        style=""
                        ><b>Nos Engagements</b></span>
                                        <div style="width: 100%; margin: 0 auto;"><div style="position: relative; padding-bottom: 62.50%; padding-top: 25px;margin-bottom:28px; height: 0;"><iframe style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" src="https://www.youtube.com/embed/iPuAzztSkOE"></iframe></div></div>
                  ...
                  <figure>
                    <div class="zoom">
                      ...
                      <g-image
                          ...
                          :src="$static.feature.belongsTo.edges[0].node.coverImage" style="height:150px"
                      />
                    </div>
                    <div class="row"><b
                        v-html="$static.feature.belongsTo.edges[0].node.title"
                      ></b>
                     <div class="columns is-mobile">
                        <figcaption class="column is-11">
                      ...
                      <p
                        v-html="
                          $static.feature.belongsTo.edges[0].node
                            .metaDescription
                        "
                        class="space"
                      ></p>
                     ...
                     <div class="column" style="font-size:16.5px;margin-left:-15px;"><arrowicon /></div>
                ...
                <div class="column is-half">
                  <figure>
                    <div class="zoom">
                      ...
                      <g-image
                        :src="
                          $static.new.belongsTo.edges[0].node.coverImage
                        "
                      />
                      <span class="tag  is-primary is-small inscrireWS"
                        styel="
...
"><b>En savoir plus</b></span
                    ...
                    <div class="row"><b
                        v-html="$static.new.belongsTo.edges[0].node.title"
                      ></b>
                     <div class="columns is-mobile">
                        <figcaption class="column is-11">
                      ...
                      <p
                        v-html="
                          $static.new.belongsTo.edges[0].node
                            .metaDescription
                        "
                        class="space"
                      ></p>
    ...
    <div v-if="alaUne">
      <h2 class="has-text-primary is-size-2 title">
        A la Une / Rintio Stories
      </h2>
      <div class="columns" style="padding-top:30px">
        <div class="column is-6">
          <figure>
            <g-image
              :src="$static.alaUne_feature.belongsTo.edges[0].node.coverImage"
              class="zoom"
            />
            <figcaption>
              <b
                v-html="$static.alaUne_feature.belongsTo.edges[0].node.title"
              ></b>
              <p
                v-html="
        ...
        <div class="column is-6">
          <div class="columns is-multiline is-12">
            ...
            <div class="column is-half">
              <figure>
                <g-image
                  :src="$static.alaUne.belongsTo.edges[1].node.coverImage"
                  class="zoom"
                />
                <figcaption>
            ...
            <div class="column is-half mb-0">
              <figure>
                <g-image
                  :src="$static.alaUne.belongsTo.edges[4].node.coverImage"
                  class="zoom"
                />
                <figcaption>
            ...
            <div class="column is-half mb-0">
              <figure>
                <g-image
                  :src="$static.alaUne.belongsTo.edges[3].node.coverImage"
                  class="zoom"
                />
                <figcaption>
      ...
      <div class="columns is-1" style="padding-top:20px">
        <div class="column">
          <figure>
            <g-image
              :src="$static.alaUne.belongsTo.edges[2].node.coverImage"
              class="zoom "
            />
            <figcaption>
        ...
        <div class="column">
          <figure>
            <g-image
              :src="$static.alaUne.belongsTo.edges[5].node.coverImage"
              class="zoom"
            />
            <figcaption>
        ...
        <div class="column">
          <figure>
            <g-image
              :src="$static.alaUne.belongsTo.edges[6].node.coverImage"
              class="zoom"
            />
            <figcaption>
      ...
      <div class="columns is-1">
        <div class="column">
          <figure>
            ...
            <figcaption>
              ...
              <p
                v-html="$static.alaUne.belongsTo.edges[7].node.metaDescription"
                class="space"
              ></p>
              <arrowicon />
            </figcaption>
        ...
        <div class="column">
          <figure>
            <g-image
              :src="$static.alaUne.belongsTo.edges[8].node.coverImage"
              class="zoom"
            />
            <figcaption>
              <b v-html="$static.alaUne.belongsTo.edges[8].node.title"></b>
              <p
                v-html="$static.alaUne.belongsTo.edges[8].node.metaDescription"
                class="space"
              ></p>
              <arrowicon />
            </figcaption>
        ...
        <div class="column">
          <figure>
            <g-image
              :src="$static.alaUne.belongsTo.edges[9].node.coverImage"
              class="zoom"
            />
            <figcaption>
              <b v-html="$static.alaUne.belongsTo.edges[9].node.title"></b>
              <p
                v-html="$static.alaUne.belongsTo.edges[9].node.metaDescription"
                class="space"
              ></p>
              <arrowicon />
            </figcaption>
