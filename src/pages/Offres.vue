<template>
  <Layout>
    ...
    <div class="bg-gray-100 h-full bg-center bg-no-repeat bg-cover mt-24  3xl:px-64 py-12">
      <div
        class="
          grid md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-4 lg:grid-flow-row xl:grid-flow-rows
        "
      >
